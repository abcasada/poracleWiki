...
|type       |`!track dragon`                   | The Pokémon type can be specified. This example tracks dragon type Pokémon |
...
|`!track snorlax cap51`                | Depending on your server configuration, you can adjust the level cap for PvP IV combination consideration for tracking. By default there is a cap of level 50. Some people configure their servers to calculate 51 as well (i.e. you have a best buddy), or level 40 (popular before the level cap) |
